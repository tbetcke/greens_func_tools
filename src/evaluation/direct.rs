...
//     where T : GftSupportedType<Item = T> {

//     pub fn assemble_laplace_kernel(
...
//     {
//         if parallel {
//             DirectEvaluator::<T>::assemble_laplace_kernel_parallel(targets, sources, result);
//         } else {
//             DirectEvaluator::<T>::assemble_laplace_kernel_serial(targets, sources, result);
//         }
//     }
//     pub fn evaluate_laplace_kernel(
//         targets: &ArrayView2<T>,
//         sources: &ArrayView2<T>,
...
//     {
//         if parallel {
//             DirectEvaluator::<T>::evaluate_laplace_kernel_parallel(targets, sources, charges, result);
//         } else {
//             DirectEvaluator::<T>::evaluate_laplace_kernel_serial(targets, sources, charges, result);
//         }
//     }

// }

// impl DirectEvaluator<f64>
// {

//     fn assemble_laplace_kernel_parallel(
//         targets: &ArrayView2<f64>,
//         sources: &ArrayView2<f64>,
...
// // impl DirectAssembler for Base<f32> {
// //     type Item = f32;
